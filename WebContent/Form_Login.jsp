...
<body>
	<div class="container">
		...
		<div class="panel panel-default">
            ...
            <div ng-show="success" class="text-success text-center">You have successfully logged in!</div>
            </div>-->
								<div class="col-md-9 col-md-offset-2">
									<div class="modal-body">
										<label class="radio-inline"><input type="radio"value="radio1"
											name="optradio"><a href="#">Đoàn viên</a></label> <label
											class="radio-inline"><input type="radio"
											name="optradio"><a href="#">Cán bộ
												Đoàn khoa</a></label> <label class="radio-inline"><input
											type="radio" name="optradio"><a href="#">Cán
												bộ Đoàn trường</a></label> <label class="radio-inline"><input
											type="radio" name="optradio"><a href="#">Admin</a></label>
									</div>
								</div>
